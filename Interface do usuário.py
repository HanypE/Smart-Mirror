...
def callApi():
	...
	response = requests.get("https://api.openweathermap.org/data/2.5/weather?lat=-22.25&lon=-45.7&lang=pt_br&units=metric&appid=d7ce3758fa00d9b4d347bf3058396e37")
                                                                                                                               #Crie uma no Open wather maphttps://openweathermap.org
